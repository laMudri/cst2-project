\title{{\large Computer Science Tripos Part II Project Proposal} \\ Formalising a semiring framework for shortest-distance problems}
\thispagestyle{empty}

\rightline{\large J. D. Wood}
\medskip
\rightline{\large Robinson College}
\medskip
\rightline{\large jdw74}

\vfil

%\centerline{\large Diploma in Computer Science Project Proposal}
%\vspace{0.4in}
%\centerline{\Large\bf Formalising a semiring framework for shortest-distance problems}
%\vspace{0.3in}
...
% Preparation
\subsection*{Weeks 1 and 2} % 10-17 - 10-28
...
\subsection*{Weeks 8, 9 and 10} % 01-16 - 02-03
Finish the algorithm and work through the remaining lemmmas before theorem 1.

\subsection*{Weeks 11 and 12} % 02-06 - 02-17
...
\subsection*{Weeks 13 and 14} % 02-20 - 03-03
...
% Writing
\subsection*{Weeks 15 and 16 (plus Easter)} % 03-06 - 03-17
